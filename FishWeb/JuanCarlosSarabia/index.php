...
<?php
   ...
   {
       $conn=mysqli_connect("localhost", "root", "", "prograweb");
       if(!$conn){
       ...
       $query = mysqli_query($conn, "SELECT * FROM escritor WHERE nombre ='".$nombre."' AND password ='".$pass."'");
...
<div class="container-fluid mb-4">
    <div class="jumbotron">
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-0 fish__login--btn">
                    ...
                    <button class="btn btn-success my-1 my-sm-1"  type="submit" style="font-family: TIMES NEW ROMAN">
      ...
      <div class="format">
        <div id="mostrar" style="">
                    <form action ="" id="loginForm" method="POST">
                        <fieldset id="body">
                            <fieldset>
                                
                                <label for="email"> Usuario </label>
                                <input type="text" name="txtusuario" placeholder="User" />
                            </fieldset>
                            <fieldset>
