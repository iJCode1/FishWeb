...
$id = $_GET['id_escritor'];
$sentencia = "SELECT *FROM escritor WHERE id_escritor = $id";
...
<div class="container-fluid mb-4">
    ...
    <div class="formato">
           <div class="container py-5">
                <div class="card">
                      <div class="card-header bg-info text-center">
                          <?php
                          echo "<h5 style='color:white'>Datos de $usuarioingresado </h5>";
                          ?>
 	                        
                      </div>
                         <div class="card-body  border border-info p-5">
                             <form class="text-center" method="POST" action="editar.php?id_escritor=<?php echo $id ?>">
                                  <div class="form-group row justify-content-center py-4">
 	                                  <label for="nombre" class="col-sm-2 col-form-label"> Nombre </label>
 	                                      <div class="col-sm-4">
                                             <input type="text" class="form-control" name="nomb" value="<?php echo $i['nombre'] ?>" readonly/>
 	                                     </div>
                                      <label for="nombre" class="col-sm-2 col-form-label">Apellido Paterno </label>
                                      <div class="col-sm-4">
                                             <input type="text" class="form-control" name="app" value="<?php echo $i['apellidoP'] ?>" readonly/>
 	                                  </div>
                                       <label for="nombre" class="col-sm-2 col-form-label">Apellido Materno </label>
                                       <div class="col-sm-4">
                                             <input type="text" class="form-control" name="apM" value="<?php echo $i['apellidoM'] ?>" readonly/>
 	                                  </div>
                                    
                                       <label for="nombre" class="col-sm-2 col-form-label">Edad </label>
                                       <div class="col-sm-4">
                                             <input type="text" class="form-control" name="edd" value="<?php echo $i['edad'] ?>" readonly/>
 	                                  </div>
                                       <label for="nombre" class="col-sm-2 col-form-label"> RFC </label>
                                       <div class="col-sm-4">
                                             <input type="text" class="form-control" name="rf" value="<?php echo $i['rfc'] ?>" readonly/>
 	                                  </div>
                        
                                       <label for="nombre" class="col-sm-2 col-form-label"> Referencias </label>
                                       <div class="col-sm-4">
                                             <input type="text" class="form-control" name="refere" value="<?php echo $i['referencia'] ?>" readonly/>
 	                                  </div>
                                       <label for="nombre" class="col-sm-2 col-form-label"> Dirección </label>
                                       <div class="col-sm-4">
                                             <input type="text" class="form-control" name="direc" value="<?php echo $i['direccion'] ?>"/>
 	                                  </div>
                                       <label for="nombre" class="col-sm-2 col-form-label"> Teléfono</label>
                                       <div class="col-sm-4">
                                             <input type="text" class="form-control" name="tele" value="<?php echo $i['telefono'] ?>"/>
 	                                  </div>
                                  </div>
                         <div>
                </div>
	    ...
	    <button type="submit" href="escritor.php" class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0"> Modificar Datos </button>
                           </form>
                           <button type="submit" href="escritor.php" class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0"> <a href="escritor.php" style="text-decoration: none; color: white;"> Regresar </a> </button>
            </div>
         </div>
</div>
   </div>
