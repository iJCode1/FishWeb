...
<div class="container-fluid mb-4">
    ...
    <?php
      ...
      <tr>
         ...
         <td> <button class="btn btn-warning"> <a href="editarperfil.php?id_escritor=<?php echo $mostrar['id_escritor']; ?>" style="text-decoration: none; color: white;" > Editar </a> </button>  
         <button class="btn btn-warning"> <a href="articulos.php" style="text-decoration: none; color: white;"> Articulos </a> </button>
         </td>
      </tr> 
      <?php 
    }
